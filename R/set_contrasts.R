...
#'
#'
#' @details \code{set_deviation_contrasts} and \code{set_effects_contrasts} are
#'   wrappers for \code{set_sum_contrasts}. Likewise,
#'   \code{set_default_contrasts} is a wrapper to \code{set_treatment_contrasts()}.
#'
#' @return nothing. These functions are called for their side effects to change
#'  the global options.
#'
